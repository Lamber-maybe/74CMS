<template>
	<div id="app" class="my_app">
              ...
              <swiper :options="swiperOption" v-if="$store.state.swiperLoaded">
				...
				<div class="content_wrapper" v-if="enclosure_resume.enclosure">
					...
					<div class="box_12 box_14">
						...
						<div class="box_content">
							<div class="resume_attachment" @click="doEnclosureDowenload()" v-if="show_contact === 0">{{ enclosure_resume.title }}</div>
		...
		<div class="generate_posters" :class="putAway ? 'generate_posters_all' : ''">
			...
			<p class="poster_item all-item" @click="putAway = !putAway"><span class="all-item-img" :class="putAway ? 'all-item-img-qx' : ''"></span></p>
		</div>
	</div>
</template>
