    ...
    <van-skeleton title avatar :row="10" :loading="mainLoading">
      <div class="box_1">
        ...
        >
          ...
          >
            求职视频<span style="font-size:12px;">({{ videonum }})</span>
          </div>
        </div>
      </div>
      <div class="box_resume_some" v-if="resumeShow === 'resume'">
        ...
        <div class="content_wrapper">
          ...
          <div
            class="box_8"
            v-if="
              resume_module.training !== undefined &&
              resume_module.training.is_display == 1 &&
    ...
    >
      <div class="dialog_tip_wrapper">
        ...
        <div
          class="tx2"
          v-if="
            parseInt(directServiceInfo.discount) > 0 &&
            directServiceInfo.use_type != 'package'
          "
        >
  ...
  methods: {
    ...
    handlerDirectService() {
      if (this.directServiceInfo.use_type == "points") {
        ...
        this.$router.push(
          "/member/order/add/common?type=service&service_type=resume_package"
        );
      } else {
    ...
    handlerDirectPay(payment) {
      let pay_data = {
        ...
        return_url:
          this.$store.state.config.mobile_domain + "resume/" + this.query_id,
      };
      this.$refs.paySubmit.handlerSubmit(
        api.company_pay_direct_service,
        pay_data
      );
      // http
