  ...
  <div id="app" class="my_app">
    <Meta
      ...
      :custom_data="{
				...
				district: base_info.intention_district_full_text,
    ...
    <van-skeleton title avatar :row="10" :loading="mainLoading">
      <div class="box_1">
        <div class="content">
          ...
          <div class="up">
            ...
            <div class="tx2">{{ base_info.age }}岁 · {{ base_info.experience_text }} · {{
      ...
      <div class="box_resume_some" v-if="resumeShow === 'resume'">
          ...
          <div class="box_3">
            ...
            <div class="box_content">
              <div class="tx2" v-for="(item, index) in intention_list" :key="index">
                <div class="name">[{{ item.district_full_text }}] {{ item.category_text }}</div>
                <div class="intent">
        ...
        <div class="form_split_10"
             v-if="resume_module.img !== undefined && resume_module.img.is_display == 1 && img_list.length > 0"></div>
        <div class="content_wrapper"
        ...
        <div class="content_wrapper" v-if="enclosure_resume.enclosure">
          <div class="box_14">
            ...
            <div class="box_content">
              <div class="resume_attachment" @click="attachmentDownload()" v-if="show_contact === 0">
