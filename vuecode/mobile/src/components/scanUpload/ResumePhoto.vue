<template>
    ...
    <div class="up-txt-line font_3 font14 qs-center">请点击下方区域上传您的 <span class="font_yellow">照片</span></div>
...
export default {
  ...
  methods: {
    ...
    uploadImg (file) {
      ...
      this.uploading = true
      http
        .postFormData(api.resume_upload_photo + '?user-token=' + this.access + '&platform=mobile', { extra: 'resume_photo', file: fileRaw })
        .then(res => {
