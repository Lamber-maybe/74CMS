...
const routes = [{
        ...
        children: [{
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/member/oauth/weixin'),
                meta: {
                    title: '第三方授权',
                    keepAlive: false,
                    loginCheck: false,
            ...
            },
            {
                ...
                name: 'ResumeSave',
                component: () =>
                    import ('../views/member/ResumeSave'),
                meta: {
                    title: '保存简历 - 会员中心',
                    keepAlive: false,
                    loginCheck: true,
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/personal/Recommend'),
                meta: {
                    title: '智能推荐 - 求职者会员中心',
                    keepAlive: false,
                    loginCheck: true,
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/job/ViewJob'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/job/AttentionMe'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/job/Interview'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        name: 'PersonalVideo',
                        component: () =>
                            import ('../views/personal/job/InterviewVideo'),
                        meta: {
            ...
            },
            {
                ...
                name: 'Personalfav',
                component: () =>
                    import ('../views/personal/follow/index'),
                children: [{
                        path: '/personal/fav/attention_company', //关注的企业
                        name: 'PersonalAttentionCompany',
                        component: () =>
                            import ('../views/personal/follow/AttentionCompany'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        name: 'PersonalFavJob',
                        component: () =>
                            import ('../views/personal/follow/JobFavorites'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/follow/Subscribe'),
                        meta: {
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/points/detailed'),
                        meta: {
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/Privacy/shield'),
                        meta: {
                            title: '屏蔽企业 - 求职者会员中心',
                            keepAlive: false,
                            loginCheck: true,
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/account/Loginlog'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/account/Feedback'),
                        meta: {
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/service/Tag'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/service/OrderList'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/personal/service/OrderDetail'),
                        meta: {
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/personal/AddResumeStep1'),
                meta: {
                    title: '创建简历 - 求职者会员中心',
                    keepAlive: false,
                    loginCheck: true,
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/personal/AddResumeStep2'),
                meta: {
                    title: '创建简历 - 求职者会员中心',
                    keepAlive: false,
                    loginCheck: true,
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/personal/AddResumeStep3'),
                meta: {
...

    {
        ...
        children: [{
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/company/Recommend'),
                meta: {
                    title: '智能推荐 - 企业会员中心',
                    keepAlive: false,
                    loginCheck: true,
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/manage/Img'),
                        meta: {
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/resume/Download'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/resume/Fav'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/resume/Browsing'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/resume/Interview'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/resume/InterviewVideo'),
                        meta: {
            ...
            // },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/account/Loginlog'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/account/Feedback'),
                        meta: {
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/SetmealDetail'),
                        meta: {
                            title: '我的套餐 - 会员服务 - 企业会员中心',
                            keepAlive: false,
                            loginCheck: true,
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/Point'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/PointLog'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/Coupon'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/OrderList'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/OrderDetail'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/Increment'),
                        meta: {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/IncrementAdd'),
                        meta: {
                            title: '增值服务 - 会员服务 - 企业会员中心',
                            keepAlive: false,
                            loginCheck: true,
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('../views/company/service/SetmealAdd'),
                        meta: {
...
const router = new VueRouter({
    mode: 'history',
    base: process.env.NODE_ENV == 'production' ? '/member/' : '/',
    routes
})
