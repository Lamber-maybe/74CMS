<template>
  <div>
    ...
    <el-dialog :title="'购买'+serviceTitle" :visible.sync="showBuyService" width="540px" @opened="initBuyService">
      <BuyIncrementDialog :job-id="result_id" :service-id="serviceId" ref="buyService" @submitPay="submitPay"
                          :type="serviceType"></BuyIncrementDialog>
    </el-dialog>
      ...
      http
        ...
        .then(res => {
          ...
          if (this.enable_addjob_num <= 0) {
            this.$confirm('您当前可发布职位数为0，建议您立即升级套餐或将暂时不招聘的职位设为关闭！', '系统提示', {
