<template>
  <div class="app-container">
    <el-tabs>
      <div class="box">
        <div class="button">
          <div @click="switchTemplate('index')" :class="type=='index' ? 'selectButton' : ''">首页模板</div>
...
import job_show_tpl from './components/job_show'
import company_show_tpl from './components/company_show'
import resume_show_tpl from './components/resume_show'
export default {
  components: {
    tplindex,
    job_show_tpl,
