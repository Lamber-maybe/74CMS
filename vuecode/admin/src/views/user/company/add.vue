<template>
  <div class="app-container">
    ...
    >
      ...
      >
        <el-input v-model="form.info.short_desc" />
      </el-form-item>
      <el-form-item
      ...
      <el-form-item
        ...
        prop="setmeal.points"
      >
        <el-input v-model="form.setmeal.points" />
      </el-form-item>
      <el-form-item
        label="赠送套餐"
        prop="setmeal.setmeal_id"
      >
      ...
      <el-form-item
        ...
        prop="setmeal.charge"
      >
        <el-input v-model="form.setmeal.charge" />
      </el-form-item>
      <el-form-item label="">
        <el-button
          type="primary"
