...
export default {
  ...
  data() {
    return {
      ...
      positionScreen: '',
      positionScreenData: [{ id: 1, name: '无' }, { id: 2, name: '有' }], // 在招职位
      followupScreen: '',
      followupScreenData: [
        { id: 0, name: '全部' },
        { id: 1, name: '今日跟进' },
      ...
      examineScreen: '',
      examineScreenData: [{ id: 1, name: '显示中' }, { id: 0, name: '不显示' }], // 审核
      mealScreen: '',
      mealScreenData: [], // 套餐
      gradeScreen: '',
      gradeScreenData: [], // 等级
      weixin: '',
      weixinData: [{ id: 0, name: '不限' }, { id: 1, name: '已绑定微信' }, { id: 2, name: '未绑定微信' }], // 微信绑定
      saleScreen: '',
      saleScreenData: [], // 销售
      pagesize: 10,
      total: 0,
      ...
      setmealDeadlineData: [{ id: 1, name: '即将到期' }, { id: 2, name: '已到期' }, { id: 3, name: '未到期' }],
      weixinFilter: '',
      gradeFilter: '',
      examineFilter: '',
      mealFilter: '',
    ...
    confirm(type) {
      ...
      if (this.collection != '') {
        for (var i = 0; i <= this.collectionData.length - 1; i++) {
          if (this.collection == this.collectionData[i].id) {
      ...
      if (this.regScreen != '') {
        for (var i = 0; i <= this.regScreenData.length - 1; i++) {
          if (this.regScreen == this.regScreenData[i].id) {
