  ...
  <div class="app-container salesStatisticsBox">
    <el-row :gutter="20">
      <div class="sale_box_all">
        <div class="sale_box1">
          <span>我的销售统计</span>
          <div><el-date-picker v-model="date" @change="monthChange" type="month" format="yyyy-MM" placeholder="选择月"></el-date-picker></div>
        </div>
        <div class="sale_box2">
          <div class="sale_box">
    ...
    <el-col :span="18">
      <el-row :gutter="20" style="margin-bottom: 20px;">
        <el-col :span="12" class="first_el-col" style="padding-left: 0;"><job_refresh height="300px" :dataArr="saleStatictisAllData" :gradeScreenData="gradeScreenData"/></el-col>
        <el-col :span="12" class="two_el-col"><company_down height="300px" :dataArr="saleStatictisAllData" :gradeScreenData="gradeScreenData"/></el-col>
        <!-- <el-col :span="6">
        <transaction_customers height="300px" />
      </el-col> -->
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12" class="first_el-col first_el_col_new"><com_login height="300px" :dataArr="saleStatictisAllData" /></el-col>
        <el-col :span="12" class="two_el-col"><job_apply height="300px" :dataArr="saleStatictisAllData" /></el-col>
        <!-- <el-col :span="6">
        <transaction_customers height="300px" />
      </el-col> -->
      </el-row>
    ...
    <el-col :span="6">
      <el-row :gutter="20" style="margin-bottom: 20px;">
        <el-col :span="24" style="padding-right: 0;"><transaction_customers height="250px" :dataArr="saleStatictisAllData" /></el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="24" style="padding-right: 0;"><new_customers height="250px" :dataArr="saleStatictisAllData" /></el-col>
      </el-row>
    </el-col>
  </div>
</template>
