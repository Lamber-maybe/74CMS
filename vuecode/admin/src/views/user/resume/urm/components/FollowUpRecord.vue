            ...
            <div class="info">
              <div class="followup">
                <div class="text">
                  ...
                  {{ item.mode }}
                  <span class="color">{{ item.link_man }}</span>
                </div>
...
<script>
import { contactList } from '@/api/company_crm'
import { getToken } from '@/utils/auth'
import { followUpList, addVisit } from '@/api/resume_urm'
...
export default {
  ...
  methods: {
    ...
    followUpList(uid){
      this.loading = true
      followUpList({ 'uid': uid, 'page': this.listParams.page, 'pagesize': this.listParams.page_size })
        .then(res => {
