<template>
  <div>
    <el-card class="box-card" style="position:relative;">
      ...
      <div id="com_add_line" :style="'height: ' + height + ';'" />
    </el-card>
  </div>
</template>

<script>
import { companyOverviewComAdd } from '@/api/stat'
...
export default {
  ...
  methods: {
    fetchData(e, init = false) {
      ...
      companyOverviewComAdd(params).then(response => {
