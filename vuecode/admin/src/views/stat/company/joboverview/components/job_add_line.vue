<template>
  <div>
    <el-card class="box-card" style="position:relative;">
      ...
      <div id="job_add_line" :style="'height: ' + height + ';'" />
    </el-card>
  </div>
</template>

<script>
import { jobOverviewJobAdd } from '@/api/stat'
...
export default {
  ...
  methods: {
    fetchData(e, init = false) {
      ...
      jobOverviewJobAdd(params).then(response => {
