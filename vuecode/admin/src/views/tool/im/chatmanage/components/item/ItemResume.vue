  ...
  <div class="clearfix">
    ...
    <div class="out">
      ...
      >
        ...
        <div class="info">{{ item.message.sex }} · {{ item.message.age }}岁 · {{ item.message.education }} ·
          {{ item.message.experience }}
        </div>
        <div class="intention">
        ...
        <div v-if="item.message.education_school!=''" class="edu">{{ item.message.education_school }} ·
          {{ item.message.education_major }}
        </div>
        <div v-if="item.message.work_companyname!=''" class="work">{{ item.message.work_companyname }} ·
          {{ item.message.work_jobname }}
        </div>
        <div
